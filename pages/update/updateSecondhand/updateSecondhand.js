...
Page({
  ...
  async _load(iid) {
    ...
    if (result.code) {
      ...
      result.data.detail.desc = util.HHToBr(result.data.detail.desc)
      result.data.detail.title = util.HHToBr(result.data.detail.title)

      if (!result.data.addressData) {
        this.setData({
          detail: result.data.detail,
          realPath: result.data.detail.pic,
          deliveryIndex: result.data.detail.invitationsDetail.deliveryWay
        })
      } else {
        this.setData({
          detail: result.data.detail,
